(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("cb15827e-19b2-4b7e-ae59-c94fc0c931a6");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'cb15827e-19b2-4b7e-ae59-c94fc0c931a6' but no matching script tag was found. ")
        return false;
      }
